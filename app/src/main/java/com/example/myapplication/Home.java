...
//        //***********************************Export Section***************************************//
    ...
    boolean checkBloodDisorder() {
        if (checkLymphocytes(_Lymph_, _WBC_) == Low && checkNeutrophil(_Neut_, _WBC_) == Low && checkRBC(_RBC_) == High) {
            return true;
        }
        return false;
    }
    ...
    boolean checkDehydration() {
        if (checkUrea(_Urea_, isEastern) == High && !checkDiet()) {
            return true;
        }
        return false;
    }
    ...
    boolean checkBloodDiseases() {
        if (checkWBC(_WBC_, _Age_) == High && !checkInfection() && !checkCancer()) {
            return true;
        }
        return false;
    }
